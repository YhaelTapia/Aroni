...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['guardar'])) {
    $nuevo_nombre = trim(string: $_POST['nombre_usuario']);
    ...
    if (!empty($_FILES['foto']['name'])) {
        $nombre_img = uniqid() . "_" . $_FILES['foto']['name'];
        ...
        $stmt->bind_param("sssssi", $nuevo_nombre, $nueva_frase, $nueva_nacionalidad, $nueva_fecha, $nombre_img, $usuario_id);
    } else {
                    ...
                    <div class="content-column">
                        <div class="panel match-history">
                            ...
                            <ul class="history-list">
                                <li>
                                    <img src="img/placeholder-game.png" alt="Game image">
